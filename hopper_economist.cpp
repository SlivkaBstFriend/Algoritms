//Кузнечик экономист. Суть программы в том, чтобы подсчитать 
//самое дешевое прохождение пути, которой введет пользователь.
//Акцент данной задачи ставится на динамическое программирование, 
//где мы ярко можем увидеть его реализацию.
