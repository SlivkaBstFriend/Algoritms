...
//Сначала задача разбивается на несколько подзадач меньшего размера. Затем эти 
//задачи решаются с помощью рекурсивного вызова или непосредственно, если их 
...
//Память:	O(n)
//
//Плюсы:	устойчивая скорость
//
//Минусы:	может быть очень памятезатратной
