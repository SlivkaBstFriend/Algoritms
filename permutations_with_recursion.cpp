...
//По сути функция шагает до базового (конечного) случая 
//возвращает значение, потом опять, потом опять. Однако,
//если наш случай уже выполнен, то рекурсия не будет вызываться
//
//Скорость:	О(n!)
//
